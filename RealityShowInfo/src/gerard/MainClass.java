...
public class MainClass {
	 ...
	 */
		 ...
		 //initalizing the objects	
			...
			do{
				...
				try{
					...
					contestant.setStNum(Integer.parseInt(scan.nextLine()));
				}catch(InvalidInputException e)
				{
					System.out.print(e.getMessage());
					flag = true;
	  ...
	  * 
	  * @param aL
	  * allows the user to print the contestants information using the print class
	  */
	 public static void printLabel(ArrayList <ContestantInformation> aL){
		 ContestantInformation contestant = new ContestantInformation();		
		 
		 //formats the contestants information using the code in the Label class
		
		 Label Label = new Label(contestant);
	 ...
	 public static void search(ArrayList <ContestantInformation> aL){
		 ...
		 SearchingArrays Search = new SearchingArrays();
			...
			if (input.equals("1"))
				Search.linearSearch(aL, contestant);
			if(input.equals("2"))
	...
	public static void main(String[] args) {
		...
		//contestant.removeALL(contestant);
